 ...
 *
 * Esta estructura almacena los componentes de un frame de salida desde el maestro hacia el esclavo, incluyendo la dirección del dispositivo, el comando a ejecutar, los datos a transmitir, la suma de verificación y la longitud del frame.
 *
 * @param adr Dirección del dispositivo destino. Determina a qué dispositivo esclavo está dirigido el frame.
 * @param cmd Comando a ejecutar por el dispositivo esclavo. Define la operación o la solicitud que el maestro está enviando.
 * @param myVector Arreglo que contiene los datos a transmitir junto con el comando. Su tamaño está definido por FRAME_DATA_VECTOR_SIZE_MOSI.
 * @param chk Suma de verificación del frame para garantizar la integridad de los datos.
 * @param longframe Longitud total del frame, incluyendo todos sus componentes. Este campo puede ser utilizado para verificar la integridad del frame y asegurar que se ha recibido por completo.
 */
 ...
 *
 * Esta estructura almacena los componentes de un frame de entrada al maestro procedente de un esclavo, incluyendo la dirección del dispositivo origen, el comando o respuesta ejecutado, los datos recibidos, la suma de verificación y la longitud del frame.
 *
 * @param adr Dirección del dispositivo origen. Indica de qué dispositivo esclavo proviene el frame.
 * @param cmd Comando ejecutado o respuesta proporcionada por el dispositivo esclavo. Puede ser una confirmación de un comando previo del maestro o una solicitud de información.
 * @param lon Longitud de los datos útiles en el frame. Este campo especifica cuántos bytes del arreglo myVector contienen datos significativos.
 * @param myVector Arreglo que contiene los datos recibidos en respuesta al comando del maestro. Su tamaño está definido por FRAME_DATA_VECTOR_SIZE_MISO.
 * @param chk Suma de verificación del frame para verificar la integridad de los datos recibidos.
 * @param longframe Longitud total del frame, incluyendo todos sus componentes. Este campo puede ser utilizado para la validación de la integridad del frame recibido.
 */
