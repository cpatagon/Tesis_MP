...
//    HAL_UART_Receive(&huart5, dataBuf, sizeof(dataBuf), 5000); // Ajusta el timeout según sea
//    necesario
//
//    // Supongamos que la concentración de PM2.5 está en los bytes 5 y 6 del dataBuf, esto es solo
//    un ejemplo
